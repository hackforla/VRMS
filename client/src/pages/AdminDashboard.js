...
const AdminDashboard = props => {
  ...
  const [currentBridage, setCurrentBrigade] = useState("");
  ...
  async function getAndSetData() {
    try {
      ...
      findUniqueUsers(locationKeys, uniqueLocations, checkInsJson);
  ...
  function findUniqueUsers(locationKeys, uniqueLocations, checkInsJson) {
    checkInsJson.forEach(cur => {
      ...
      if (!uniqueLocations[userLocation].includes(userId)) {
        uniqueLocations[userLocation].push(userId);
      }
      uniqueLocations.All.push(userId);
    });
  }
  ...
  //     const uniqueDtlaVolunteers = Array.from(
  //       new Set(flattenedDtlaArray.map(volunteer => volunteer.userId))
  //     );
  ...
  //     for (
  //       let eventCount = 0;
  //       eventCount < westsideEvents.length;
  //       eventCount++
  //     ) {
  ...
  //     const uniqueWestsideVolunteers = Array.from(
  //       new Set(flattenedWestsideArray.map(volunteer => volunteer.userId))
  //     );
  ...
  //     for (
  //       let eventCount = 0;
  //       eventCount < southLaEvents.length;
  //       eventCount++
  //     ) {
  ...
  //     const uniqueSouthLaVolunteers = Array.from(
  //       new Set(flattenedSouthLaArray.map(volunteer => volunteer.userId))
  //     );
  ...
  const dtlaHours =
    sortedDtlaCheckIns !== null && sortedDtlaCheckIns.length * 3;
  const westsideHours =
    sortedWestsideCheckIns !== null && sortedWestsideCheckIns.length * 3;
  const southLaHours =
    sortedSouthLaCheckIns !== null && sortedSouthLaCheckIns.length * 3;

  const avgHoursPerVol =
    totalVolunteers !== null &&
    (round((totalHours / totalVolunteers.length) * 100) / 100).toFixed(2);
  const avgHoursPerDtlaVol =
    dtlaVolunteers !== null &&
    (round((dtlaHours / dtlaVolunteers.length) * 100) / 100).toFixed(2);
  const avgHoursPerWestsideVol =
    westsideVolunteers !== null &&
    (round((westsideHours / westsideVolunteers.length) * 100) / 100).toFixed(2);
  const avgHoursPerSouthLaVol =
    southLaVolunteers !== null &&
    (round((southLaHours / southLaVolunteers.length) * 100) / 100).toFixed(2);

  const handleBrigadeChange = e => {
    setCurrentBrigade(e.currentTarget.value);
    ...
    <div className="flex-container">
      <div className="dashboard">
          ...
          <div className="dashboard-chart-container">
            {dtlaVolunteers !== null &&
              ...
              brigade === "All" && (
                <DonutChart
                  data={[
                    { value: dtlaVolunteers.length, color: "#2A768A" },
                    { value: westsideVolunteers.length, color: "#102D49" },
                    { value: southLaVolunteers.length, color: "#CD1F42" }
                  ]}
                  width={160}
                  height={160}
                  innerRadius={40}
                ...
                <div className="key-container">
                  <div className="key-info-container">
                    ...
                    <div className="key-location">
                      <p>
                        DTLA: {dtlaVolunteers !== null && dtlaVolunteers.length}
                      </p>
                    </div>
                  </div>

                  <div className="key-info-container">
                    <div className="key-color dark-blue"></div>
                    <div className="key-location">
                      <p>
                        Westside:{" "}
                        {westsideVolunteers !== null &&
                          westsideVolunteers.length}
                      </p>
                    </div>
                  </div>

                  <div className="key-info-container">
                    <div className="key-color dark-red"></div>
                    <div className="key-location">
                      <p>
                        South LA:{" "}
                        {southLaVolunteers !== null && southLaVolunteers.length}
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="dashboard-chart-container">
            {dtlaHours !== null &&
              ...
              brigade === "All" && (
                <DonutChart
                  data={[
                    { value: dtlaHours, color: "#2A768A" },
                    { value: westsideHours, color: "#102D49" },
                    { value: southLaHours, color: "#CD1F42" }
                  ]}
                  width={160}
                  height={160}
                  innerRadius={40}
        ...
        {/* <div className="dashboard-stats">
          ...
          <div className="dashboard-chart-container">
            {avgHoursPerDtlaVol !== null &&
              avgHoursPerWestsideVol !== null &&
              avgHoursPerSouthLaVol !== null &&
              brigade === "All" && (
                <DonutChart
                  data={[
                    { value: avgHoursPerDtlaVol, color: "#2A768A" },
                    { value: avgHoursPerWestsideVol, color: "#102D49" },
                    { value: avgHoursPerSouthLaVol, color: "#CD1F42" }
                  ]}
                  width={160}
                  height={160}
                  innerRadius={40}
                ...
                <div className="key-container">
                  <div className="key-info-container">
                    ...
                    <div className="key-location">
                      <p>
                        DTLA:{" "}
                        {avgHoursPerDtlaVol !== null && avgHoursPerDtlaVol}
                      </p>
                    </div>
                  </div>
