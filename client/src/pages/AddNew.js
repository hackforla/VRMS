...
import { Label, Input, Select, Option, OptionPlaceholder, SecondaryButton, AuxiliaryButton } from '../components/Form';
...
const AddNew = (props) => {
  ...
  const editEventDates = (index, action) => {
    ...
    if (action === 'add') {
      ...
      currEventDates.splice(index + 1, 0, oneWeekFromCurrDate.format("YYYY[-]MM[-]DD"));
            ...
            <div className="addnewevent">
              <form onSubmit={event => createNewEvents(event)}>
                  ...
                  <div className="event-div-container">
                    ...
                    <Select id="event-type" className="small" value={eventType}
                      onChange={event => {
                    ...
                    >
                      ...
                      {eventTypes.map((eventType, index) => <Option value={eventType} key={index}>{eventType}</Option>)}
                    </Select>
                    {(eventType === 'hacknight') && (
                  ...
                  <div className="event-div-container">
                    ...
                    <Select
                      ...
                      onChange={hacknightLocation ? null : event => setEventCity(event.target.value)}
                  ...
                  <SecondaryButton {...isSubmitting && 'disabled'} className="center" type="submit">Save</SecondaryButton>
                </form>
            </div>
          )}
        </div>
