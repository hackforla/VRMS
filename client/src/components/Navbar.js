          ...
          props.location.pathname === '/success' ? (
            ...
            <div
              className={`navbar-logo ${
                (props.location.pathname === '/admin' || props.location.pathname === '/events' || props.location.pathname === '/useradmin' || props.location.pathname.startsWith('/project')) && 'justify-right'
              }`}
            >
              <img src="/hflalogo.png" alt="Hack for LA Logo"></img>
            </div>
