...
describe('Unit Tests for userRouter', () => {
  ...
  describe('READ', () => {
    ...
    it('should get a list of Users who manage projects with GET to /api/users/projectManagers through UserController', async (done) => {
      //Setup
      //Mock the UserController function that this route calls with expected results
  ...
  describe('UPDATE', () => {
    it('should update a User with PATCH to /api/users/:UserId through UserController', async (done) => {
      ...
      const response = await request.patch(`/api/users/${mockId}`).send(mockUpdatedEmail);
  ...
  describe('DELETE', () => {
    it('should delete a specific user by Id with DELETE /api/users/:UserId through UserController', async (done) => {
      ...
      const response = await request.delete(`/api/users/${mockId}`).send(mockUpdatedEmail);
